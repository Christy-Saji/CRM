...
// Check if product_id column exists in employees table
$productColumnExists = false;
try {
    $checkStmt = $conn->query("SHOW COLUMNS FROM employees LIKE 'product_id'");
    $productColumnExists = $checkStmt->rowCount() > 0;
...
if (isset($_POST['add_employee'])) {
    $name = $_POST['name'];
    $email = $_POST['email'];
    $password = $_POST['password']; // In a real app, you should hash this password
...
if ($productColumnExists) {
    ...
    // Add empty product_name for consistent data structure
    foreach ($employees as &$employee) {
        $employee['product_name'] = 'N/A';
    }
}
...
<div class="container">
    ...
    <div class="form-container">
        <form method="POST">
            ...
            <?php if ($productColumnExists && !empty($products)): ?>
                <div class="form-group">
                    <label for="product_id">Assigned Product:</label>
                    <select id="product_id" name="product_id" class="form-control" <?php echo $productColumnExists ? '' : 'disabled'; ?>>
